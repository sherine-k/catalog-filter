...
func TestFilter_KeepMeta(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			filter:   NewFilter(FilterConfiguration{}).(filter_package.MetaFilter),
		...
		},
		{
			...
			filter:   NewFilter(FilterConfiguration{Packages: []Package{{Name: "foo"}, {Name: "bar"}}}).(filter_package.MetaFilter),
			meta:     &declcfg.Meta{Schema: declcfg.SchemaPackage, Name: "foo"},
			expected: true,
		},
		{
		...
		},
		{
			...
			filter:   NewFilter(FilterConfiguration{Packages: []Package{{Name: "bar"}, {Name: "baz"}}}).(filter_package.MetaFilter),
			meta:     &declcfg.Meta{Schema: declcfg.SchemaPackage, Name: "foo"},
			expected: false,
		},
		{
