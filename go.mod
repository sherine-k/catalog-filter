module github.com/sherine-k/test-filter

go 1.22.5

replace github.com/operator-framework/operator-registry => /home/skhoury/go/src/github.com/operator-framework/operator-registry
